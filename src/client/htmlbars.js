// MIMOSA - wrapped in cjs wrapper
define(function (require, exports, module) {
  "use strict";

  // MIMOSA - BEGIN morph/dom-helper/build-html-dom.js
  ...
  // MIMOSA - END morph/dom-helper/build-html-dom.js

  // MIMOSA - BEGIN morph/dom-helper/classes
  ...
  // MIMOSA - END morph/dom-helper/classes


  // MIMOSA - BEGIN morph/morph.js
  ...
  // MIMOSA - END morph/morph.js

  // MIMOSA - BEGIN morph/dom-helper.js
  var doc = typeof document === 'undefined' ? false : document;
  ...
  // MIMOSA - END morph/dom-helper.js

  // MIMOSA - BEGIN htmlbars-runtime.js
  // Pulled in SafeString/merge
  ...
  exports.content = content;function component(morph, tagName, context, hash, options, env) {
  ...
  exports.componentFallback = componentFallback;function element(domElement, helperName, context, params, hash, options, env) {
  ...
  exports.element = element;function attribute(params, hash, options /*, env*/) {
  ...
  exports.attribute = attribute;function concat(params, hash, options /*, env*/) {
    var value = "";
  ...
  exports.partial = partial;function subexpr(helperName, context, params, hash, options, env) {
    var helper = this.lookupHelper(helperName, context, options);
    if (helper) {
